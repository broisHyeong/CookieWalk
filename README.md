...
## 개선하고 싶은 점 
1. 시작점까지 가는 네비게이션 기능 추가
2. 사용자가 그린 경로 자동 보정
3. 사용자의 흥미를 돋구기 위해 산책 중 AR 보상 기능 추가 -> 포켓몬고 참고


## 결과 
![image](https://github.com/user-attachments/assets/b91495d9-c411-4980-922d-1c39b49e385a)

쿠키워크 프로젝트를 통해 최종적으로 우수상을 수상하였습니다.

## 느낀점 
사실 디지털 스마트부산 캠프를 신청할까 말까 고민을 많이 했었습니다. 이제 3학년이라 전공 공부도 바빴고, 다른 활동들에서도 책임을 맡고 있었기 때문입니다. 1학기 동안 매우 바쁜 시간을 보냈고 때로는 정말 힘들기도 했지만, 지금 돌아보면 최고의 선택이었습니다.

프로젝트를 진행하면서 여러 어려움에 직면했지만, 팀원들과의 적극적인 의사소통을 통해 문제를 해결할 수 있었습니다. 이를 통해 문제 해결 능력, 커뮤니케이션 능력, 그리고 자신감을 얻을 수 있었습니다. 또한, 개발에 대한 저의 방향도 설정할 수 있었습니다. 아직 많이 부족하지만, 앞으로 더 나아갈 수 있는 길이 많다고 생각합니다. 열심히 해보겠습니다!

프로젝트를 진행하며 만난 소중한 인연들에 다시 한번 감사드립니다.
